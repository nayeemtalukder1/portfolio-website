...
export default function SkillsTabAbout() {
  ...
  return (
    <div className="space-y-12">
      ...
      >
        <h2 className="text-8xl font-black bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
          Where'm I Expert?
        </h2>
        <p className="text-white/70 text-lg mt-6 max-w-3xl mx-auto">
          I design profitable and visually appealing websites that offer an excellent user experience 
          with a clean, modern style. My development approach is progressive, adhering to best practices. 
          Currently, my main area of expertise is front-end web development, including customized animations and design. 
          I am also actively learning back-end development.
        </p>
      </motion.div>
      ...
      >
        {skills.map((skill, i) => (
          <motion.button
            ...
            } bg-white/10 backdrop-blur-xl text-white font-bold`}
          >
            {skill.name}
          </motion.button>
        ))}
      ...
      <AnimatePresence mode="wait">
        {selectedSkill && (
          <motion.div
            ...
            className="flex justify-center items-center gap-20 mt-20"
          >
            {/* CIRCULAR PROGRESS */}
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <motion.div
                  ...
                  className="text-center"
                >
                  <h3 className="text-7xl font-black text-cyan-400">{progress}%</h3>
                  <p className="text-white/70 text-xl mt-2">Click a Skill</p>
                </motion.div>
              </div>
            </div>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h3 className={`text-6xl font-black bg-gradient-to-r ${selectedSkill.color} bg-clip-text text-transparent`}>
                {selectedSkill.name}
              </h3>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-8 h-8 text-green-400" />
                <span className="text-white text-xl">Mastered</span>
              </div>
              <p className="text-white/70 text-lg max-w-md">
                I use {selectedSkill.name} daily in production projects. 
                From complex animations to full-stack apps — I got it covered.
              </p>
            </motion.div>
          </motion.div>
        )}
